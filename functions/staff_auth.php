...
if($isError){
  header("Location: ../staff_login.php?message");
}

else{
  $sql_login = "SELECT * FROM staffs WHERE email = '$email' AND password = '$password'";
  ...
  if($num_of_rows > 0){
    ...
    redirect("../staff_login.php", "Email or Password not correct");
  }
