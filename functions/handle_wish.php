  ...
  if(isset($_POST['scope'])){
    ...
    switch ($scope)
    {
      case "add":
        ...
        $select = "SELECT * FROM wish_list WHERE prod_id = '$pid' AND user_id = '$user_id'";
        ...
        if($num_of_row > 0){
          ...
          // ('$user_id', '$pid', '$qty')";
          $insert = "INSERT INTO wish_list (user_ip, user_id, prod_id) VALUES 
          ('$user', '$user_id', $pid)";
        ...
        $select = "SELECT * FROM wish_list WHERE prod_id = '$pid' AND user_ip = '$user_ip'";
        // $select = "SELECT * FROM carts WHERE prod_id = '$pid' AND user_ip = '$user_ip'";
        $result = mysqli_query($conn, $select);
        ...
        if($num_of_row > 0){
          ...
          // $insert = "INSERT INTO carts (user_id, prod_id, prod_qty) VALUES 
          // ('$user_id', '$pid', '$qty')";
          $insert = "INSERT INTO wish_list (user_ip, prod_id) VALUES 
          ('$user_ip', $pid)";
          $query = mysqli_query($conn, $insert);
