...
if(trim($name1)==''){
  $errorBag['name1'] = "This field is required";
  $hasError = true;
}

if(trim($email1)==''){
  $errorBag['email1'] = "This field is required";
  $hasError = true;
}

if(trim($phone1)==''){
  $errorBag['phone1'] = "This field is required";
  $hasError = true;
}

if(trim($pincode1)==''){
  $errorBag['pincode1'] = "This field is required";
  $hasError = true;
}

if(!filter_var($email1, FILTER_VALIDATE_EMAIL)) {
  $errorBag['validemail1'] = "Email is not Valid";
  $hasError = true; 
}

if(trim($address1)==''){
  $errorBag['address1'] = "This field is required";
  $hasError = true;
}
